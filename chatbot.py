...
def send():
    ...
    elif (user == "what do you do" or user == "what kinds of exercises are there" or user == "have you something"):
        txt.insert(END, "\n" + "Bot -> I give fitness exercises as mentioned in the description.")
        e.delete(0, END)
        return
